...
impl super::Attach for WalkerState {
...
impl super::Particle for Walker {
...
impl Walker {
    ...
    fn simulate(&self) -> WalkerSimulationSingle {
        WalkerSimulationSingle::new(self.clone())
    }

    fn simulate_many(&self, n: usize) -> WalkerSimulation {
        WalkerSimulation::new(self.clone(), n)
    }
}
